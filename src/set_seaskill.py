...
class seaSkill:
    ...
    def open(self):
        ...
        self.weaponList={'프리스트(남)':['낫', '베틀액스', '십자가', '토템', '염주'],
                         ...
                         '마법사(여)':['스탭', '로드', '빗자루', '창', '봉'],
                         '크리에이터':['스탭', '로드', '빗자루', '창', '봉']}
        self.elseeqipList=['경갑 머리어깨', '경갑 상의', '경갑 하의', '경갑 허리', '경갑 신발', '중갑 머리어깨', '중갑 상의',
                           '중갑 하의', '중갑 허리', '중갑 신발', '천 머리어깨', '천 상의', '천 하의', '천 허리', '천 신발',
                           '판금 머리어깨', '판금 상의', '판금 하의', '판금 허리', '판금 신발', '가죽 머리어깨', '가죽 상의',
                           '가죽 하의', '가죽 허리', '가죽 신발', '목걸이', '팔찌', '반지', '칭호', '마법석', '보조장비']
